(function() {
    ...
    function LandingController($scope, $timeout) {
        ...
        const testimonials = [
            ...
            { text: "I found hidden ancient temples in Tamil Nadu that aren't listed on regular travel sites. TripSavvy is truly a gem finder!", author: "Rohan Sharma" },
            { text: "The guides matched with me in Rajasthan made our family holiday rich with history and completely hassle-free.", author: "Priya Patel" }
        ];
